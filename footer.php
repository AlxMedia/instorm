		...
		<div id="footer-bottom">
			...
			<div class="pad group">
				...
				<div class="grid one-full">
					...
					<div id="credit">
						<p><?php esc_html_e('Powered by','instorm'); ?> <a href="<?php esc_url( __( 'https://wordpress.org', 'instorm' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','instorm'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
					</div><!--/#credit-->
					<?php endif; ?>
